 ...
 */
class_string_parameter(sBBN_withY_file,"/external/bbn/Alex_BBN_RG_Helium.dat","sBBN file")
class_string_parameter(sBBN_withY_deuterium_file,"/external/bbn/Alex_BBN_RG_Deuterium.dat","sBBN file")
class_string_parameter(sBBN_file,"/external/bbn/Alex_BBN_LCDM_Helium.dat","sBBN file")
class_string_parameter(sBBN_deuterium_file,"/external/bbn/Alex_BBN_LCDM_Deuterium.dat","sBBN file")
...
class_precision_parameter(start_large_k_at_gamma_y_over_h,double,0.0001)  /**< largest wavelengths start being sampled sufficiently before decay of Y particle. This is quantified in terms of the ratio of Y decay rate to hubble, \f$ Gamma_yp/H \f$. Start when this ratio equals start_large_k_at_gamma_y_over_h. Decrease this value to start integrating the wavenumbers earlier in time. */
