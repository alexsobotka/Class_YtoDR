...
struct background
{
  ...
  double Omega0_g_prime; /**< \f$ \Omega_{0 \gamma} \f$: corrected photons if Y particle decay into DR */

  double Omega0_b; /**< \f$ \Omega_{0 b} \f$: baryons */

  double Omega0_ur; /**< \f$ \Omega_{0 \nu r} \f$: ultra-relativistic neutrinos */
  double Omega0_ur_prime; /**< \f$ \Omega_{0 \nu r} \f$: corrected ultra-relativistic neutrinos if Y particle decay into DR*/
  double N_ur;
  ...
  double Omega0_yp; /**< \f$ \Omega_{0 yp} \f$: decaying Y particle */
  double Omega0_yr; /**< \f$ \Omega_{0 yr} \f$: Y decay radiation */
  ...
  int index_bg_rho_yp;        /**< Y particle density */
  int index_bg_rho_yr;        /**< radiation from Y decay */
  ...
  int index_bi_rho_yp;/**< {B} Y particle density */
  int index_bi_rho_yr;/**< {B} Radiation from Y decay */
  ...
  short has_yp;         /**< presence of decaying Y particle? */
  short has_yr;         /**< presence of radiaiton from Y decay? */
...
#define _k_B_eV_ 8.617333262e-5
