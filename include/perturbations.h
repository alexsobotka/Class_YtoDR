...
struct perturbations
{
  ...
  short has_source_delta_yp;  /**< do we need source for delta of Y? */
  ...
  short has_source_theta_yp; /**< do we need source for theta of Y? */
  ...
  int index_tp_delta_yp;/**< index value for delta of Y */
  ...
  int index_tp_theta_yp;  /**< index value for theta of Y */
...
struct perturbations_vector
{
  ...
  int index_pt_delta_yp; /**< yp density */
  int index_pt_theta_yp; /**< yp velocity */
