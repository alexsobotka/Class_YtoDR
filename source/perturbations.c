    ...
    for (index_k=0; index_k<ppt->k_size[index_md]; index_k++) {
      ...
      if (output_format == class_format) {
        ...
        if (ppt->has_density_transfers == _TRUE_) {
          ...
          class_store_double(dataptr,tk[ppt->index_tp_delta_yp],ppt->has_source_delta_yp,storeidx);
        ...
        if (ppt->has_velocity_transfers == _TRUE_) {
          ...
          class_store_double(dataptr,tk[ppt->index_tp_theta_yp],ppt->has_source_theta_yp,storeidx);
...
int perturbations_output_titles(
  ...
  if (output_format == class_format) {
    ...
    if (ppt->has_density_transfers == _TRUE_) {
      ...
      class_store_columntitle(titles,"d_yp",pba->has_yp);
    ...
    if (ppt->has_velocity_transfers == _TRUE_) {
      ...
      class_store_columntitle(titles,"t_yp",pba->has_yp);
...
int perturbations_init(
  ...
  if (pba->has_yp == _TRUE_) {
    ...
    class_test((ppt->has_cdi == _TRUE_) || (ppt->has_bi == _TRUE_) || (ppt->has_nid == _TRUE_) || (ppt->has_niv == _TRUE_),
               ppt->error_message,
               "Non-adiabatic initial conditions not coded in presence of decaying Y particle");
...
int perturbations_indices(
  ...
  ppt->has_source_delta_yp = _FALSE_;
  ...
  ppt->has_source_theta_yp = _FALSE_;
  ...
  for (index_md = 0; index_md < ppt->md_size; index_md++) {
    ...
    if (_scalars_) {
      ...
      if (ppt->has_density_transfers == _TRUE_) {
        ...
        if (pba->has_yp == _TRUE_)
          ppt->has_source_delta_yp = _TRUE_;
        if (pba->has_fld == _TRUE_)
      ...
      if (ppt->has_velocity_transfers == _TRUE_) {
        ...
        if (pba->has_yp == _TRUE_)
          ppt->has_source_theta_yp = _TRUE_;
        if (pba->has_fld == _TRUE_)
      ...
      class_define_index(ppt->index_tp_delta_yp,   ppt->has_source_delta_yp,  index_type,1);
      ...
      class_define_index(ppt->index_tp_theta_yp,   ppt->has_source_theta_yp,  index_type,1);
    ...
    if (is_early_enough == _TRUE_) {
      ...
      if (pba->has_yp == _TRUE_){
        if ((ppw->pvecback[pba->index_bg_a]*
            ...
            ppr->start_large_k_at_tau_h_over_tau_k) 
            || (pba->Gamma_yp/ppw->pvecback[pba->index_bg_H] > ppr->start_large_k_at_gamma_y_over_h)  //If there is Y decay, initialize modes well before decay occurs
            )
...
int perturbations_prepare_k_output(struct background * pba,
  ...
  if (ppt->k_output_values_num > 0) {
    ...
    if (ppt->has_scalars == _TRUE_){
      ...
      /* Decaying Y particle */
      class_store_columntitle(ppt->scalar_titles, "delta_yp", pba->has_yp);
      class_store_columntitle(ppt->scalar_titles, "theta_yp", pba->has_yp);
      /* Decay radiation */
      ...
      class_store_columntitle(ppt->scalar_titles, "cs2_dr",   pba->has_dr);
      /* Scalar field scf */
...
int perturbations_vector_init(
  ...
  if (_scalars_) {
    ...
    class_define_index(ppv->index_pt_delta_yp,pba->has_yp,index_pt,1); /* Y density */
    class_define_index(ppv->index_pt_theta_yp,pba->has_yp,index_pt,1); /* Y velocity */
  ...
  /** - case of switching approximation while a wavenumber is being integrated */
    ...
    if (_scalars_) {
      ...
      if (pba->has_yp == _TRUE_) {
        ...
        ppv->y[ppv->index_pt_delta_yp] =
          ppw->pv->y[ppw->pv->index_pt_delta_yp];

        if (ppt->gauge == newtonian) {
          ppv->y[ppv->index_pt_theta_yp] =
            ppw->pv->y[ppw->pv->index_pt_theta_yp];
        }
      }
...
int perturbations_initial_conditions(struct precision * ppr,
  ...
  double delta_dr=0, theta_dr=0;
  double q,epsilon,k2;
  int index_q,n_ncdm,idx;
  double rho_r,rho_m,rho_nu,rho_m_over_rho_r, rho_cdm =0.;
  double fracnu,fracg,fracb,fraccdm = 0.,fracidm = 0.,fracyp = 0., fracdr = 0., fracyp_dr = 0.;
  double om;
  ...
  if (_scalars_) {
    ...
    if (pba->has_yp == _TRUE_) {
      rho_m += ppw->pvecback[pba->index_bg_rho_yp];
    }
    ...
    if(pba->has_yp == _TRUE_){
      fracyp =  ppw->pvecback[pba->index_bg_rho_yp]/rho_m;
      if (pba->has_dr == _TRUE_){
        fracdr = ppw->pvecback[pba->index_bg_rho_dr]/rho_r;
        fracyp_dr = ppw->pvecback[pba->index_bg_rho_yp]/ppw->pvecback[pba->index_bg_rho_dr];
      }
    }
    ...
    */
    ...
    if ((ppt->has_ad == _TRUE_) && (index_ic == ppt->index_ic_ad)) {
      ...
      if (pba->has_yp == _TRUE_) {
        ppw->pv->y[ppw->pv->index_pt_delta_yp] = 3./4.*ppw->pv->y[ppw->pv->index_pt_delta_g]; /* Y density */
        /* Y velocity velocity vanishes initially in the synchronous gauge */
      }
      ...
      if ((pba->has_ur == _TRUE_) || (pba->has_ncdm == _TRUE_) || (pba->has_dr == _TRUE_) || (pba->has_idr == _TRUE_)) {
        ...
        if ((pba->has_dr == _TRUE_) && (pba->has_yp == _TRUE_)){  
          //delta_dr = ppw->pv->y[ppw->pv->index_pt_delta_g];
          //delta_dr = 1./4.*ppw->pv->y[ppw->pv->index_pt_delta_g];
          delta_dr = 0.85*ppw->pv->y[ppw->pv->index_pt_delta_g];
          theta_dr = theta_ur*(17/40.)*(15.+4*fracnu)/(23.+4*fracnu);
        }
      }
    ...
    if (ppt->gauge == newtonian) {
      ...
      */
      ...
      if ( pba->has_yp == _TRUE_ ) {
        delta_tot += rho_m_over_rho_r*fracyp*ppw->pv->y[ppw->pv->index_pt_delta_yp]/(1.+rho_m_over_rho_r);
           if (pba->has_dr == _TRUE_){
            delta_tot -= fracdr*delta_ur/(1.+rho_m_over_rho_r);
            delta_tot += fracdr*delta_dr/(1.+rho_m_over_rho_r);
            velocity_tot -= (4./3.)*fracdr*theta_ur/(1.+rho_m_over_rho_r);
         }
      }
      ...
      if (pba->has_yp == _TRUE_) {
        ppw->pv->y[ppw->pv->index_pt_delta_yp] -= (3.*a_prime_over_a + a*pba->Gamma_yp)*alpha;
        ppw->pv->y[ppw->pv->index_pt_theta_yp] = k*k*alpha;
      }
      ...
      if ((pba->has_ur == _TRUE_) || (pba->has_ncdm == _TRUE_) || (pba->has_dr == _TRUE_)  || (pba->has_idr == _TRUE_)) {
        ...
        if (pba->has_dr == _TRUE_){
          ...
          if (pba->has_yp == _TRUE_){
            delta_dr += (-4.*a_prime_over_a + a*pba->Gamma_yp*ppw->pvecback[pba->index_bg_rho_yp]/ppw->pvecback[pba->index_bg_rho_dr])*alpha;
          }
        }
      }
    ...
    if (pba->has_dr == _TRUE_) {
      ...
      //ppw->pv->y[ppw->pv->index_pt_F0_dr+2] = 0.0;
...
int perturbations_total_stress_energy(
  ...
  double rho_dr_over_f, delta_rho_dr, delta_p_dr, delta_p_over_delta_rho_dr;
  ...
  if (_scalars_) {
    ...
    /* Y contribution */
    if (pba->has_yp == _TRUE_) {
      ppw->delta_rho += ppw->pvecback[pba->index_bg_rho_yp]*y[ppw->pv->index_pt_delta_yp];
      ppw->rho_plus_p_theta += ppw->pvecback[pba->index_bg_rho_yp]*y[ppw->pv->index_pt_theta_yp];

      ppw->rho_plus_p_tot += ppw->pvecback[pba->index_bg_rho_yp];

      if (ppt->has_source_delta_m == _TRUE_) {
        delta_rho_m += ppw->pvecback[pba->index_bg_rho_yp]*y[ppw->pv->index_pt_delta_yp]; // contribution to delta rho_matter
        rho_m += ppw->pvecback[pba->index_bg_rho_yp];
      }
      if ((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_)) {
        rho_plus_p_theta_m += ppw->pvecback[pba->index_bg_rho_yp]*y[ppw->pv->index_pt_theta_yp]; // contribution to [(rho+p)theta]_matter
        rho_plus_p_m += ppw->pvecback[pba->index_bg_rho_yp];
      }
    }
    ...
    if (pba->has_dr == _TRUE_) {
      ...
      */
      ...
      delta_rho_dr = rho_dr_over_f*y[ppw->pv->index_pt_F0_dr];
      ...
      //ppw->rho_plus_p_shear += 0.0;
      delta_p_dr = 1./3.*rho_dr_over_f*y[ppw->pv->index_pt_F0_dr];
      ppw->delta_p += 1./3.*rho_dr_over_f*y[ppw->pv->index_pt_F0_dr];
      ppw->rho_plus_p_tot += 4./3. * ppw->pvecback[pba->index_bg_rho_dr];
      delta_p_over_delta_rho_dr = delta_p_dr/delta_rho_dr;
    }
...
int perturbations_sources(
  ...
  if (_scalars_) {
    ...
    /* delta_yp */
    if (ppt->has_source_delta_yp == _TRUE_) {
      _set_source_(ppt->index_tp_delta_yp) = y[ppw->pv->index_pt_delta_yp]
        + (3.*a_prime_over_a+a*pba->Gamma_yp)*theta_over_k2; // N-body gauge correction;
    }
    ...
    /* theta_yp */
    if (ppt->has_source_theta_yp == _TRUE_) {
      _set_source_(ppt->index_tp_theta_yp) = y[ppw->pv->index_pt_theta_yp]
        + theta_shift; // N-body gauge correction
    }
...
int perturbations_print_variables(double tau,
  ...
  double delta_yp=0.,theta_yp=0.;
  double delta_dr=0.,theta_dr=0.,shear_dr=0., f_dr=1.0, delta_rho_dr = 0., delta_p_dr=0., delta_p_over_delta_rho_dr=0.;
  ...
  double q,q2,epsilon;
  /** - ncdm sector ends */
  double phi=0.,psi=0.,alpha=0.,h_prime=0., decay_term = 0., normal_term=0.;
  ...
  if (_scalars_) {
    ...
    if (ppt->gauge == synchronous) {
      ...
      h_prime = 2.*alpha*k*k - 6*y[ppw->pv->index_pt_eta];
    ...
    if (pba->has_yp == _TRUE_) {
      ...
      delta_yp = y[ppw->pv->index_pt_delta_yp];
      theta_yp = y[ppw->pv->index_pt_theta_yp];
    ...
    if (pba->has_dr == _TRUE_) {
      ...
      delta_rho_dr = delta_dr*pvecback[pba->index_bg_rho_dr];
      theta_dr = y[ppw->pv->index_pt_F0_dr+1]*3./4.*k/f_dr;
      shear_dr = y[ppw->pv->index_pt_F0_dr+2]*0.5/f_dr;
      delta_p_dr = 1./3.*(pvecback[pba->index_bg_rho_dr]/f_dr)*y[ppw->pv->index_pt_F0_dr];
      delta_p_over_delta_rho_dr = delta_p_dr/delta_rho_dr;
      //shear_dr = 0.0;
    }
    ...
    /* No matter what gauge is, output will be Newtonian */
    //if (ppt->gauge == synchronous) { 

    /*If gauge = synchronous, output in synchronous. If gauge = Newtonian, output in Newtonian*/
    if (0 == 1) { 
      ...
      if (pba->has_dr == _TRUE_) {
        ...
        if (pba->has_yp == _TRUE_) {
          delta_dr += (-4.*a*H+a*pba->Gamma_yp*pvecback[pba->index_bg_rho_yp]/pvecback[pba->index_bg_rho_dr])*alpha;
          theta_dr += k*k*alpha;
        }
      }
      ...
      if (pba->has_yp == _TRUE_) {
        delta_yp += alpha*(-a*pba->Gamma_yp-3.*a*H);
        theta_yp += k*k*alpha;
      }
    ...
    /* Decaying Y particle */
    class_store_double(dataptr, delta_yp, pba->has_yp, storeidx);
    class_store_double(dataptr, theta_yp, pba->has_yp, storeidx);
    /* Decay radiation */
    ...
    class_store_double(dataptr, delta_p_over_delta_rho_dr, pba->has_dr, storeidx);
...
int perturbations_derivs(double tau,
  ...
  if (_scalars_) {
    ...
    if (pba->has_yp == _TRUE_) {
      ...
      dy[pv->index_pt_delta_yp] = -(y[pv->index_pt_theta_yp]+metric_continuity)
        - a * pba->Gamma_yp / k2 * metric_euler; /* Y density */

      dy[pv->index_pt_theta_yp] = - a_prime_over_a*y[pv->index_pt_theta_yp] + metric_euler; /* Y velocity */
    }
    ...
    if ((pba->has_yp == _TRUE_)&&(pba->has_dr == _TRUE_)) {
      ...
      */
      ...
      f_dr = pow(pow(a,2)/pba->H0,2)*pvecback[pba->index_bg_rho_dr];
      fprime_dr = pba->Gamma_yp*pvecback[pba->index_bg_rho_yp]*pow(a,5)/pow(pba->H0,2); 

      /** - ----> dr F0 */
      dy[pv->index_pt_F0_dr] = -k*y[pv->index_pt_F0_dr+1]-4./3.*metric_continuity*f_dr+
        fprime_dr*(y[pv->index_pt_delta_yp]+metric_euler/k2);
      // if (a < 5.*pow(10.,-10)){
      //   printf("a: %e       , F0'_dr: %e\n", a, dy[pv->index_pt_F0_dr]);
      // }

      /** - ----> dr F1 */
      dy[pv->index_pt_F0_dr+1] = k/3.*y[pv->index_pt_F0_dr]-2./3.*k*y[pv->index_pt_F0_dr+2]*s2_squared +
        4*metric_euler/(3.*k)*f_dr + fprime_dr/k*y[pv->index_pt_theta_yp];

      /** - ----> exact dr F2 */
      dy[pv->index_pt_F0_dr+2] = 8./15.*(3./4.*k*y[pv->index_pt_F0_dr+1]+metric_shear*f_dr) -3./5.*k*s_l[3]/s_l[2]*y[pv->index_pt_F0_dr+3];
      //dy[pv->index_pt_F0_dr+2] = 0.0;
